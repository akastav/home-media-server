...
THREE.SceneLoader.prototype = {
        ...
        parse: function ( json, callbackFinished, url ) {
                ...
                function handle_objects() {
                        handle_children( result.scene, data.object.children );
                                ...
                                if ( object === undefined ) {
                                        ...
                                        // lights
                                                ...
                                                if (objJSON.matrix) {
                                                 ...
                                                 light.matrix.fromArray(objJSON.matrix);
                ...
                for ( geoID in data.geometries ) {
                        ...
                        } else if ( geoJSON.type === "plane"  || geoJSON.type === "PlaneGeometry") {

                                geometry = new THREE.PlaneGeometry( geoJSON.width, geoJSON.height, geoJSON.widthSegments, geoJSON.heightSegments );
                                geometry.name = geoID;
                                result.geometries[ geoID ] = geometry;

                        } else if ( geoJSON.type === "sphere" || geoJSON.type === "SphereGeometry") {

                                geometry = new THREE.SphereGeometry( geoJSON.radius, geoJSON.widthSegments, geoJSON.heightSegments );
                                geometry.name = geoID;
                                result.geometries[ geoID ] = geometry;

                        } else if ( geoJSON.type === "cylinder" || geoJSON.type === "CylinderGeometry") {

                                geometry = new THREE.CylinderGeometry( geoJSON.topRad, geoJSON.botRad, geoJSON.height, geoJSON.radSegs, geoJSON.heightSegs );
                                geometry.name = geoID;
                                result.geometries[ geoID ] = geometry;

                        } else if ( geoJSON.type === "torus"  || geoJSON.type === "TorusGeometry") {

                                geometry = new THREE.TorusGeometry( geoJSON.radius, geoJSON.tube, geoJSON.segmentsR, geoJSON.segmentsT );
                                geometry.name = geoID;
                                result.geometries[ geoID ] = geometry;

                        } else if ( geoJSON.type === "icosahedron"  || geoJSON.type === "IcosahedronGeometry") {
                ...
                if ( result.fogs && data.defaults && data.defaults.fog ) {
