...
//----
	...
	'NEWDASH_PRELOAD_TEXT' => 'Если загрузка слишком долгая, то возможно в коде есть ошибка или скрипт слишком долго выполняет запрошенную операцию.',
	...
	'UPDATEBACKUP_CLOSE_CONSOLE_AUTO' => 'Консоль будет закрыта автоматически...',
	'UPDATEBACKUP_GET_REDIRECT' => 'Запрос редиректа...',
	'UPDATEBACKUP_GET_REDIRECT_TO_MERKET' => 'Запрос редиректа в маркет дополнений...',
	'UPDATEBACKUP_UPDATE_GET_DONE' => 'Обновления установлены!',
	'UPDATEBACKUP_REQUEST_REBOOT' => 'Запрос перезагрузки MajorDoMo',
	'UPDATEBACKUP_REBOOT_WELL_DONE' => 'Система перезагружена!',
	'UPDATEBACKUP_ERROR_DOWNLOAD' => 'Невозможно скачать архив! Операция будет остановлена!',
	'UPDATEBACKUP_APPLY_UPDATE' => 'Применяем обновление...',
	'UPDATEBACKUP_RESTORE_DB_FOR' => 'Восстанавливаем базу данных из',
	'UPDATEBACKUP_RESTORE_DB' => 'Восстанавливаем базу данных',
	'UPDATEBACKUP_RESTORE_DB_DONE' => 'База данных восстановлена!',
	'UPDATEBACKUP_UNPACKEGE_FROM_TO' => 'Распаковка файлов из',
	'UPDATEBACKUP_UNPACKEGE' => 'Распаковка',
	'UPDATEBACKUP_DISABLED' => 'Отключаем',
	'UPDATEBACKUP_PATCHING' => 'Патчим',
	'UPDATEBACKUP_CHECK_MODULE_UPDATE' => 'Проверяем обновление модулей...',
	'UPDATEBACKUP_APPLY_CHANGES' => 'Применяем изменения',
	'UPDATEBACKUP_REQUEST_BACKUP_CREATE' => 'Запрос создания резервной копии',
	'UPDATEBACKUP_SAVE_DESIGN' => 'Сохраняем дизайн...',
	'UPDATEBACKUP_SAVE_CODE' => 'Сохраняем код...',
	'UPDATEBACKUP_SAVE_DATA' => 'Сохраняем данные...',
